...
встроєний debootstrap працює за принципом CODENAME TARGET DISTRO/MIRROR тобто noble це кодова назва TARGET директорія в яку качається дистрибутив а DISTRO/MIRROR це дзеркало з якого debootstrap викачує базовий rootfs
